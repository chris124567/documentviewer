...
def document_view(docid): # obfuscate download url and prevent easy mirroring of site
	s = TimedJSONWebSignatureSerializer(current_app.config['SECRET_KEY'], 60*30) # 60 secs by 30 mins
